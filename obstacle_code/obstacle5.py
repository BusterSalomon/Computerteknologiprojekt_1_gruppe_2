...
class Obstacle():
    ...
    # 5. get angular velocity based on the center average distance, and the direction
    ...
    def obstacle(self):
        ...
        while not rospy.is_shutdown():
            ...
            if (lidar_center and lidar_left and lidar_right): 
                ...
                angular_vel = self.get_angular_vel(center_avrg, direction)
                linear_vel, collision_flag = self.get_linear_vel(center_avrg)
